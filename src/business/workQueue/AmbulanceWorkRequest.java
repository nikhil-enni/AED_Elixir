...
public class AmbulanceWorkRequest extends WorkRequest {
    ...
    Ambulance ambulance;
    EmergencyPatientRequest emergencyPatientRequest;
    Date requestdate;
    ...
    public EmergencyPatientRequest getEmergencyPatientRequest() {
        return emergencyPatientRequest;
    }

    public void setEmergencyPatientRequest(EmergencyPatientRequest emergencyPatientRequest) {
